...
void SDLGameObject::draw_angle()
{
    TextureManager::Instance()->draw_angle(m_textureID, (int)m_position.getX(), (int)m_position.getY(), m_width, m_height, TheGame::Instance()->getRenderer(), m_angle);
}

void SDLGameObject::clean()
{
    TextureManager::Instance()->clean(TheGame::Instance()->getRenderer());
}
